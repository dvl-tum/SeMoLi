...
HYDRA_FULL_ERROR=1 python3 trainer.py \
	...
	models.hyperparams.edge_attr=min_mean_max_difftrajtime \
	...
	models.loss_hyperparams.node_weight=25 \
	models.loss_hyperparams.edge_weight=100 \
	models.hyperparams.use_node_score=0.7 \
	...
	models.hyperparams.augment=True \
