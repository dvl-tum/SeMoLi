...
HYDRA_FULL_ERROR=1 python3 trainer.py \
	...
	data.trajectory_dir=/dvlresearch/jenny/debug_trajectories_waymo/traj_dataset_waymo/trajectories2/trajectories2 \
	data.processed_dir=/dvlresearch/jenny/debug_trajectories_waymo/processed/normal/trajectories2/trajectories2 \
