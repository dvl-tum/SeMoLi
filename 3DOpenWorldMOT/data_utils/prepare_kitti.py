"""
If KD-tree should be used for sampling during training 
...
data_config = os.path.join('semantic-kitti.yaml')
...
grid_size = 0.06
dataset_path = '../data/kitti/sequences'
output_path = '../data/kitti/sequences' + '_' + str(grid_size)
